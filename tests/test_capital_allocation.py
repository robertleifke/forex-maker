"""Unit tests for V4PositionManager.calculate_mint_amounts."""
...
def _make_adapter(balance0_raw: int, balance1_raw: int) -> SimpleNamespace:
    """Minimal self-mock for V4PositionManager.calculate_mint_amounts."""
    token0 = MagicMock()
    ...
    return SimpleNamespace(
        _w3=w3,
        _lp_account=SimpleNamespace(address="0xLP"),
...
class TestCalculateMintAmounts:
    def test_returns_full_lp_wallet_balance(self):
        ...
        a0, a1 = V4PositionManager.calculate_mint_amounts(adapter)
